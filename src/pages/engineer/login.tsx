...
const EngineerLoginPage: React.FC = () => {
        ...
        <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
          <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
            ...
            <div className="mt-4 text-sm text-center">
              <Link
                href="/auth/forgot-password?type=engineer"
            ...
            <div className="mt-6">
              ...
              <div className="mt-6">
                <Link
                  ...
                  className="w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-blue-600 bg-white hover:bg-gray-50"
                >
                  新規登録はこちら
                </Link>
              </div>
